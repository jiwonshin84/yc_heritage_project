...
# 최신 예측용: 최근 7일 범위에서 공공데이터 조회 (어제까지)
...
st.caption(f"기준일자: {tm} (실시간 대기오염 연동)")
...
display_df_env = three_days_display.copy()
display_df_env["date"] = display_df_env["date"].dt.strftime("%Y-%m-%d")
